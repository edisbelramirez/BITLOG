                ...
                -->
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special1" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="./?view=dias&opt=all">
                                  <i class="icon"><i class="bi bi-circle"></i> </i><i class="sidenav-mini-icon"> U </i><span class="item-name">Usuarios logueados</span>
                                </a>
                            </li>
                        </ul>
                    </li>
          ...
          <div class="container-fluid navbar-inner">
            ...
            <?php $user = UserData::getById($_SESSION["user_id"]); ?>
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title"><?php echo $user->name; ?></h6>
                ...
                -->
                    ...
                    <li><a class="dropdown-item" href="./?view=settings&opt=all">Configuración</a></li>
                     ...
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           <a href="../../dashboard/index.html" class="navbar-brand d-flex align-items-center mb-3">
                              ...
                              <h4 class="logo-title ms-3">ADMINISTRACION</h4>
                           </a>
